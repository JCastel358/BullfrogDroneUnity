...
{
    [Serializable]
    public class RemainingTrajectoryFixedPointsGizmos : BaseTrajectoryFixedPointsGizmos
    {
        public void DrawGizmos(Trajectory trajectory, Trajectory relativeTo = default)
        {
            ...
            relativeTo.GetRemainingTrajectoryTimes(RemainingEndTypes.FixedCeiling, out var tFrom, out var tTo);
